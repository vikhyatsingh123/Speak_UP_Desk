...
?>
<div style=" background-image: linear-gradient(white 0%,grey 100%);">
  ...
  <div class="container">
    ...
    <div class="main">
       ...
       <div style="" id="lfooter">
		<p style="margin-top:5px;">Copyright &copy; Speak up <a href="#" title="email">By Vikhyat,Vipul,Shashank and Simran </a>  </p>
